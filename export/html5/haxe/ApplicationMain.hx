...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("bloodflood", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("bloodflood", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "bloodflood";
		app.meta["name"] = "bloodflood";
